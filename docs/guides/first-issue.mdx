...
You will be prompted for your `GENTIC_API_URL` (for example `https://app.gentic.chat/api/v1`) and your `GENTIC_API_KEY` (your Gentic API key). Once saved, run `gentic start` again.
