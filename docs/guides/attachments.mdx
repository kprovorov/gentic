...
Drag files onto the composer or click the paperclip button — or, in the **Files** card, choose files and select **Upload**. You can select multiple files. Composer files upload when you save, run, or send the accompanying prompt text.
