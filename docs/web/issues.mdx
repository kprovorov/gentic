...
<Warning>
  Retrying is irreversible: Gentic deletes the stored conversation and pull-request links for the issue, then creates a fresh kickoff message from the current body. It does not delete pull requests from GitHub.
</Warning>
