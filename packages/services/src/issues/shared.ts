...
const ISSUE_SELECT =
  "id,project_id,number,title,body,status,type,priority,agent_provider,issue_model,session_id,active_run_id,active_host_id,pinned_host_id,run_started_at,run_finished_at,run_error,usage_limit_reset_at,create_pr_automatically,automatic_review_enabled,has_unpublished_agent_changes,created_at,updated_at"
