...
SELECT is(
  ...
  null,
  'requeued issue has no old worker lease'
);
...
SELECT is(
  ...
  null,
  'unban restores the worker identity'
);
...
SELECT is(
  (
    SELECT count(*)::integer
      FROM public.issues
     WHERE active_worker_id = '00000000-0000-4000-8000-100000000001'
        or active_run_id in (
          '30000000-0000-4000-8000-100000000001',
          '30000000-0000-4000-8000-100000000002'
        )
...
UPDATE public.issues
   SET status = 'queued',
       active_worker_id = '00000000-0000-4000-8000-100000000001',
...
SELECT is(
  ...
  0,
  'delete hard-deletes the worker record'
);
...
SELECT is_empty(
  ...
  $$,
  'deleted workers disappear from normal reads'
);
...
UPDATE public.issues
   SET status = 'run-failed',
       active_worker_id = '00000000-0000-4000-8000-100000000002',
...
SELECT is(
  ...
  null,
  'offline delete clears failed worker lease'
);
...
SELECT is(
  ...
  false,
  'delete does not reveal another user worker'
);
...
SELECT is(
  ...
  1,
  'cross-user delete leaves the other worker intact'
);
  ...
  $$
    UPDATE public.issues
       SET status = 'in-progress',
           ...
           active_run_id = '30000000-0000-4000-8000-100000000003'
     WHERE id = '20000000-0000-4000-8000-100000000001'
       AND active_worker_id = '00000000-0000-4000-8000-100000000001'
...
SELECT ok(
  NOT has_function_privilege(
    'authenticated',
    'public.rename_worker(text, uuid, text, timestamptz)',
    'EXECUTE'
  ),
  'authenticated role cannot directly invoke worker lifecycle RPCs'
);
...
SELECT ok(
  ...
  'service role can invoke worker lifecycle RPCs'
);
