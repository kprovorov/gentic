...
SELECT is(
  ...
  null,
  'finished run releases worker capacity'
);
...
SELECT is(
  ...
  null,
  'follow-up issue does not retain its previous worker'
);
...
SELECT is(
  ...
  null,
  'reset releases the old worker capacity'
);
...
SELECT throws_ok(
  ...
  '23514',
  null,
  'database rejects worker assignments without an active run'
);
